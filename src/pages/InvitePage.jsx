...
import { UserPlus, Share2, Crown, Star, BarChart3, Settings } from "lucide-react";

// Mock referral data (later from backend)
const DEFAULT_REFERRAL_LINK = "https://dreamearn.app/invite?rid=abc123xyz";
const mockInvites = [
  {
    id: 1,
    name: "User A",
      ...
      <div className="container py-8">
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-[#9ca3af]">
                Earn {2.0} AED per successful referral. Your friends can also get bonus on signup.
              </p>
            </div>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <div
              className="flex-1 p-4 rounded-xl border border-[rgba(255,255,255,0.1)] bg-white/4 flex items-center justify-between group cursor-pointer"
              onClick={() => copyToClipboard(DEFAULT_REFERRAL_LINK)}
            >
          ...
          <div className="space-y-3">
            {mockInvites.length ? (
              ...
              <div className="text-center text-[#9ca3af] p-4">
                No invites yet. Start sharing your link!
              </div>
            )}
          </div>
        </motion.div>
